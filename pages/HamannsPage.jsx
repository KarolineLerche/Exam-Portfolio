...
import Hamanns from "../assets/hamanns/hamannsforside.png";
...
export default function HamannsPage() {
    ...
    useEffect(()=>{
        async function getPosts(){
            const response = await fetch("https://wp.karolinelerche.dk/wp-json/wp/v2/posts?_embed&categories=8");
...
{/* WORDPRESS FRONTPAGE */}
            <section>
                ...
                <p id="hamannsnumber" className="absolut uppercase HalyardFont mobile_hidden"> 05 </p>
                <img className="absolute" id="Hamanssfront"  src={Hamanns} alt="albert"/>
            </section>

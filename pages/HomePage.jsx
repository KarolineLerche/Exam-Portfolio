...
export default function HomePage() {
    ...
    useEffect(()=>{
        async function getPosts(){
            const response = await fetch("https://wp.karolinelerche.dk/wp-json/wp/v2/posts?_embed&categories=6");
...
{/* 1. LANDINGPAGE */}
                <section className="Flexbox relative" id="Frontpage"> 
                    ...
                    <div className="mobile_hidden" id="FrontBackground">
                        ...
                        <Link to="/experiencepage" className="Button">More about me</Link>
                        </div>
                    </div>
